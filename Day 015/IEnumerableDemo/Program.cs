...
namespace IEnumerableDemo
{
    class Program
    {
        ...
        {
            //creating a generic IEnumerale varible that takes any collection of type int
            //we will use this variable to store the collection that will get returned by the GetCollection() method
            IEnumerable<int>unknownCollection;
            unknownCollection=GetCollection(1);

            System.Console.WriteLine("This was a List<int>");
            ...
            System.Console.WriteLine("This was a Queue<int>");
            ...
            System.Console.WriteLine("This was a array of int");
        ...
        {
            //create a list of numbers and initialie it
